...
class DataValidation:
    ...
    def isFolderPathAvailable(self)->bool:
        try:
            # True means avaliable false means not avaliable4
    ...
    def is_validation_successfull(self):
        try:
            ...
            if self.isFolderPathAvailable() == True:
                ...
                is_train_filename_validated = self.train_Data.validate_file(file_name=train_filename)
                ...
                is_train_missing_values_whole_column = self.train_Data.missing_values_columns()
                ...
                is_test_filename_validated = self.test_Data.validate_file(
                ...
                logging.info(
                    f"Test_set status|is Test filename validated?: {is_test_filename_validated}|is test columns numbers validated?: {is_test_column_numbers_validated}|is test column names validated? {is_test_column_name_same}| whole missing columns? {is_test_missing_values_whole_column}")
