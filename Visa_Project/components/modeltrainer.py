...
import os,sys
from Visa_Project.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact
from Visa_Project.entity.config_entity import ModelTrainerConfig
from Visa_Project.utils.utils import load_numpy_array_data,save_object,load_object
from Visa_Project.entity.model_factory import MetricInfoArtifact,ModelFactory,GridSearchedBestModel
...
class VisaApprovalPredictor:
    ...
    def predict(self,X):
        ...
        """
        transformed_feature = self.preprocessing_object.transformer(X)
